...
import HeroImage from "../assets/images/kanafeh-hero.png"
  ...
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7" data-aos="fade-right">
            ...
            <a href="#" className="bg-orange inline-flex items-center justify-center px-5 py-3 mr-3 text-lg font-medium text-center text-black px-8 py-2 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                View Menu
            </a>
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex border-4 border-orange" data-aos="fade-left">
